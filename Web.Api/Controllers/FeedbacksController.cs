...
namespace EventFeedback.Web.Api.Controllers
{
    ...
    public class FeedbacksController : ApiController
    {
        ...
        {
            using (new TraceLogicalScope(_traceSource, "FeedbacksController:Post"))
            {
                ...
                Guard.Against<ArgumentException>(!entity.EventId.HasValue && !entity.SessionId.HasValue,
                    "entity.eventid or entity.sessionid should be set");
                Guard.Against<ArgumentException>(entity.EventId.HasValue && entity.SessionId.HasValue,
        ...
        {
            using (new TraceLogicalScope(_traceSource, "FeedbacksController:Put"))
            {
                Guard.Against<ArgumentException>(entity == null, "entity cannot be empty");
        ...
        {
            using (new TraceLogicalScope(_traceSource, "FeedbacksController:Delete"))
            {
                Guard.Against<ArgumentException>(id == 0, "id cannot be empty or zero");
