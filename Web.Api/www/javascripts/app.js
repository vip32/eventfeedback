...
module.exports = AppLayout = (function(superClass) {
  ...
  ItemView.prototype.onShow = function() {
    ...
    if (this.tagAttrs != null) {
      ...
      for (attr in this.tagAttrs) {
        results.push(this.$el.attr(attr, this.tagAttrs[attr](this.model)));
      }
      return results;
    }
  };
...
module.exports.Model = Event = (function(superClass) {
...
module.exports.Collection = EventsCollection = (function(superClass) {
  extend(EventsCollection, superClass);
...
module.exports.Model = EventReport = (function(superClass) {
  extend(EventReport, superClass);
...
module.exports.Collection = EventReportsCollection = (function(superClass) {
  extend(EventReportsCollection, superClass);
...
module.exports.Model = EventTag = (function(superClass) {
  extend(EventTag, superClass);
...
module.exports.Collection = EventTagsCollection = (function(superClass) {
  extend(EventTagsCollection, superClass);
...
module.exports.Model = Feedback = (function(superClass) {
...
module.exports.Collection = FeedbacksCollection = (function(superClass) {
  extend(FeedbacksCollection, superClass);
...
module.exports.Model = FeedbackDefinition = (function(superClass) {
  extend(FeedbackDefinition, superClass);
...
module.exports.Collection = FeedbackDefinitionsCollection = (function(superClass) {
  extend(FeedbackDefinitionsCollection, superClass);
...
module.exports.Model = Header = (function(superClass) {
...
module.exports.Collection = HeadersCollection = (function(superClass) {
  extend(HeadersCollection, superClass);
  ...
  HeadersCollection.prototype.active = function(roles) {
    ...
    filtered = this.filter((function(_this) {
      return function(item) {
        ...
        visible = (ref = item.get('visible')) != null ? ref : true;
...
module.exports.Model = Resource = (function(superClass) {
...
module.exports.Collection = ResourceCollection = (function(superClass) {
  extend(ResourceCollection, superClass);
  ...
  ResourceCollection.prototype.key = function(key) {
    ...
    return (ref = result != null ? result.get('value') : void 0) != null ? ref : '';
  };
...
module.exports.Model = Role = (function(superClass) {
...
module.exports.Collection = RolesCollection = (function(superClass) {
  extend(RolesCollection, superClass);
...
module.exports.Model = Session = (function(superClass) {
...
module.exports.Collection = SessionsCollection = (function(superClass) {
  extend(SessionsCollection, superClass);
...
module.exports.Collection = StoreCollection = (function(superClass) {
  extend(StoreCollection, superClass);
...
module.exports.Model = User = (function(superClass) {
...
module.exports.Collection = UsersCollection = (function(superClass) {
...
module.exports.Model = UserProfile = (function(superClass) {
...
module.exports.Model = UserToken = (function(superClass) {
  extend(UserToken, superClass);
...
module.exports = Controller = (function(superClass) {
  ...
  function Controller(options) {
    this.onSaveUsers = bind(this.onSaveUsers, this);
    this.showUsersGenerator = bind(this.showUsersGenerator, this);
...
module.exports = UsersGeneratorItemView = (function(superClass) {
  extend(UsersGeneratorItemView, superClass);
  ...
  UsersGeneratorItemView.prototype.serializeData = function() {
    var ref;
    return {
      resources: (ref = this.resources) != null ? ref.toJSON() : void 0,
...
module.exports = UsersGeneratorView = (function(superClass) {
  extend(UsersGeneratorView, superClass);
  ...
  UsersGeneratorView.prototype.serializeData = function() {
    ...
    return {
      resources: (ref = this.resources) != null ? ref.toJSON() : void 0,
      roles: (ref1 = this.roles) != null ? ref1.pluck('name') : void 0
    };
  };
  ...
  UsersGeneratorView.prototype.onGenerate = function(e) {
    var data, i, j, k, len, ref, ref1;
    e.preventDefault();
    this.collection.reset();
    data = Backbone.Syphon.serialize(this);
    ref = data.accountnames.split(';');
    ...
    if (data.amount > 0) {
      for (i = k = 1, ref1 = data.amount; 1 <= ref1 ? k <= ref1 : k >= ref1; i = 1 <= ref1 ? ++k : --k) {
        this.collection.add({
...
module.exports = DebugView = (function(superClass) {
...
module.exports = SigninView = (function(superClass) {
...
module.exports = EventDetailsView = (function(superClass) {
  extend(EventDetailsView, superClass);
  ...
  EventDetailsView.prototype.serializeData = function() {
    ...
    return {
      resources: (ref = this.resources) != null ? ref.toJSON() : void 0,
      tags: (ref1 = this.tags) != null ? ref1.toJSON() : void 0,
      model: this.model.toJSON(),
...
module.exports = EventEditView = (function(superClass) {
  extend(EventEditView, superClass);
  ...
  EventEditView.prototype.serializeData = function() {
    ...
    return {
      resources: (ref = this.resources) != null ? ref.toJSON() : void 0,
      definitions: (ref1 = this.definitions) != null ? ref1.toJSON() : void 0
    };
  };
...
module.exports = EventReportView = (function(superClass) {
  extend(EventReportView, superClass);
  ...
  EventReportView.prototype.onBack = function() {
    ...
    return vent.trigger('event:details', (ref = this.model) != null ? ref.id : void 0);
  };
...
module.exports = EventIndexView = (function(superClass) {
  extend(EventIndexView, superClass);
...
module.exports = EventDetailsView = (function(superClass) {
  ...
  EventDetailsView.prototype.serializeData = function() {
    ...
    return {
      resources: (ref = this.resources) != null ? ref.toJSON() : void 0,
      model: this.model.toJSON(),
      feedback: (ref1 = this.feedback) != null ? ref1.toJSON() : void 0,
...
module.exports = SessionItemView = (function(superClass) {
  extend(SessionItemView, superClass);
...
module.exports.HeaderItem = ItemView = (function(superClass) {
  extend(ItemView, superClass);
  ...
  ItemView.prototype.serializeData = function() {
    var ref, ref1, ref2;
    return {
      title: (ref = (ref1 = this.resources.find(((function(_this) {
        return function(resource) {
          return resource.get('key') === _this.model.get('resource');
        };
      })(this)))) != null ? ref1.get('value') : void 0) != null ? ref : this.model.get('title'),
      href: this.model.get('href'),
      icon: (ref2 = this.model.get('glyphicon')) != null ? ref2 : config.sidebarglyphicon
    };
  };
...
module.exports.Header = View = (function(superClass) {
...
User = (function() {
  ...
  User.prototype.roles = function(values) {
    ...
    if (!_.isEmpty(values)) {
      ...
      return (ref = settings.get('api_userroles')) != null ? ref : [];
    }
  };
  ...
  User.prototype.remember = function(value) {
    ...
    if (_.isBoolean(value)) {
      ...
      return (ref = settings.get('api_remember')) != null ? ref : false;
    }
  };
...
Vent = (function(superClass) {
  extend(Vent, superClass);
